          ...
          <div className="w3-third">
            <div className="w3-white w3-text-grey w3-card-4">
              <div className="w3-container mt-2">
                <h3 className="mb-4 text-dark mt-4 text-center resumeHead">
                  Surendra Vadaparthy
                </h3>
                <p>
                ...
                <div className="w3-light-grey w3-round-xlarge w3-small">
                  <div className="w3-container w3-center w3-round-xlarge w3-teal C">
                    80%
                  </div>
                </div>
                <p>Web development</p>
                ...
                <div className="w3-light-grey w3-round-xlarge w3-small">
                  <div className="w3-container w3-center w3-round-xlarge w3-teal E">
                    65%
                  </div>
                </div>
                <p>MS-office</p>
                <div className="w3-light-grey w3-round-xlarge w3-small">
                  <div className="w3-container w3-center w3-round-xlarge w3-teal F">
                    80%
                  </div>
                </div>
                <br />
                ...
                <p>Telugu</p>
                <div className="w3-light-grey w3-round-xlarge w3-small">
                  <div className="w3-container w3-center w3-round-xlarge w3-teal o">
                    100%
                  </div>
                </div>
                <p>English</p>
                ...
                <div className="w3-light-grey w3-round-xlarge w3-small">
                  <div className="w3-container w3-center w3-round-xlarge w3-teal K">
                    50%
                  </div>
                </div>
                <br />
            ...
            <div className="w3-container w3-card w3-white">
              ...
              <div className="w3-container">
                ...
                <h6 className="w3-text-teal">
                  ...
                  2021
                  <span className="w3-tag w3-teal w3-round ml-1">Current</span>
                </h6>
              ...
              <div className="w3-container">
                <h5 className="w3-opacity">
                  <b>Sri Gayathri Junior College</b>
                </h5>
                <h6 className="w3-text-teal">
              ...
              <div className="w3-container">
                <h5 className="w3-opacity">
                  <b>Wisdom Grammer High School</b>
                </h5>
                <h6 className="w3-text-teal">
